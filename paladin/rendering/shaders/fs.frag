...
float4 main(VS_OUTPUT input) : SV_TARGET
{
    ...
    Texture2D<float4> normal_map = ResourceDescriptorHeap[NonUniformResourceIndex(6+2)];
    ...
    Texture2D<float4> albedo = ResourceDescriptorHeap[NonUniformResourceIndex(6)];
